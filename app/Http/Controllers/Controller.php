...
OA\Server (url: 'https://laravel-sqlite-api-swagger-jh.azurewebsites.net/api', description: "staging server"),
OA\Server(url: 'https://laravel-sqlite-api-swagger-jh.azurewebsites.net/api', description: "production server"),
