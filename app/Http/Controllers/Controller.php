...
OA\Server (url: 'https://laravel-sqlite-api-swagger-jh.azurewebsites.net', description: "staging server"),
OA\Server(url: 'https://laravel-sqlite-api-swagger-jh.azurewebsites.net', description: "production server"),
